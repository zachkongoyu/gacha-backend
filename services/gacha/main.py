...
async def pull_gacha(count: int = 1, authorization: Optional[str] = Header(None)):
    """
    Perform gacha pulls.
    ...
    return PullResponse(pulls=pulls, pity_counter=current_pity, next_pity_at=pity_threshold)
...
async def get_rates():
    ...
    """
    return {
        "rates": {"5-star": "0.6%", "4-star": "5.1%", "3-star": "94.3%"},
        "pity": {
            "threshold": 90,
